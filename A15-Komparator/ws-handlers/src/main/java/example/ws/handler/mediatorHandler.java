	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		try {
			if (outboundElement.booleanValue()) {
				...
				String keyStoreFilePath1 = "A15_Mediator.jks";
				...
				byte[] digitalSignature = cryptkeeper.createDigitalSignature(CertUtil.getPrivateKeyFromKeyStoreFile(keyStoreFilePath1, keyStorePassword, keyAlias, keyPassword), body.toString().getBytes());
			...
			//	String message = sb.toString();
               ...
               // boolean isValidSignature = cryptkeeper.checkDigitalSignature(pk,Message.getBytes(),parseBase64Binary(digest));
				...
				InputStream is = new ByteArrayInputStream(cname.getBytes(StandardCharsets.UTF_8));
